...
const COLOR_MAP: Partial<Record<LcDataset, Record<string, string>>> = {
  ...
  ESA_WorldCover: {
    ...
    Cropland: "#f096ff", "Built-up": "#fa0000",
    "Barren/sparse vegetation": "#b4b4b4", "Snow and ice": "#f0f0f0",
    "Open water": "#0032c8", "Herbaceous wetland": "#0096a0",
    Mangroves: "#00cf75", "Moss and lichen": "#fae6a0",
  },
  ESRI_LandCover: {
    Water: "#1A5BAB", Trees: "#358221", Grass: "#87D19E",
    "Flooded vegetation": "#FFDB5C", Crops: "#ED022A",
    "Scrub/Shrub": "#EDE9E4", "Built area": "#F2FAFF",
    "Bare ground": "#C8C8C8", "Snow/Ice": "#DEE4FF",
    Clouds: "#45C2A5", Rangeland: "#B1FF05",
  },
  JAXA_FNF4: {
    "Dense Forest": "#006400", "Non-Dense Forest": "#00a000",
    "Non-Forest": "#feff99", Water: "#0000ff",
  },
  JAXA_FNF: {
    Forest: "#006400", "Non-Forest": "#feff99", Water: "#0000ff",
  },
};
...
const LULC_CLASS_ID: Record<string, string> = {
  Water: "Air", Trees: "Pohon", Grass: "Rumput",
  "Flooded vegetation": "Vegetasi Tergenang", Crops: "Lahan Pertanian",
  "Shrub & Scrub": "Semak Belukar", "Built Area": "Area Terbangun",
  "Bare ground": "Lahan Gundul", "Snow & Ice": "Salju & Es",
  "Dense Forest": "Hutan Rapat", "Non-Dense Forest": "Hutan Tidak Rapat",
  "Forest Formation": "Formasi Hutan", "Peat Swamp Forest": "Hutan Rawa Gambut",
  "Non-Forest Natural Formation": "Formasi Alam Non-Hutan",
  "Other Non-Forest Natural Vegetation": "Vegetasi Alam Non-Hutan Lainnya",
  "Rice Paddy": "Sawah", "Oil Palm": "Sawit",
  "Pulpwood Plantation": "Hutan Tanaman Industri", "Other Agriculture": "Pertanian Lainnya",
  "Non-Vegetated Area": "Area Non-Vegetasi", "Mining Pit": "Tambang",
  "Urban Area": "Area Perkotaan", "Other Non-Vegetation": "Non-Vegetasi Lainnya",
  "Water Body": "Badan Air", Aquaculture: "Akuakultur/Tambak",
  "River, Lake, Ocean": "Sungai, Danau, Laut", "Not Observed / Cloud": "Tidak Teramati / Awan",
  Shrubland: "Semak", Shrubs: "Semak", Grassland: "Padang Rumput", Grasslands: "Padang Rumput",
  Cropland: "Lahan Pertanian", "Built-up": "Terbangun",
  "Barren/sparse vegetation": "Lahan Gundul/Vegetasi Jarang", "Snow and ice": "Salju dan Es",
  "Open water": "Air Terbuka", "Herbaceous wetland": "Lahan Basah", Mangroves: "Mangrove",
  "Moss and lichen": "Lumut", "Scrub/Shrub": "Semak", "Built area": "Area Terbangun",
  "Snow/Ice": "Salju/Es", Clouds: "Awan", Rangeland: "Padang Penggembalaan",
  Forest: "Hutan", "Non-Forest": "Non-Hutan",
};
...
export function colorForClass(cls: string, dataset: LcDataset, yearData: Record<number, LcYearResult>): string {
